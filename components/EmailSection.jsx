    ...
    <section id="contact" className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
        ...
        <div className='z-10'>
            ...
            <p className='text-[#ADB7BE] mb-4 max-w-md'>
                ...
                Whether you have a question or just want to say hi, I&apos;ll rty my best to get back to you!
            </p>
                ...
                <form className='flex flex-col' onSubmit={handleSubmit}>
                    <div className='mb-6'>
                        ...
                        <input
                            ...
                            id='email' 
                            required
                            className='bg-[#18191E] broder border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' 
                    ...
                    <div className='mb-6'>
                        <label htmlFor='message' className='text-white block mb-2 text-sm font-medium'>Subject</label>
                        <textarea 
                            name='message'
                            id='message' 
                            required
